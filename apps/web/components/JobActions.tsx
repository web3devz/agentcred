        ...
        return (
          <div key={m.id} className="milestone">
            ...
            <div className="actions">
              ...
              <button className="btn" disabled={loadingKey !== null} onClick={() => run(`/jobs/${id}/milestones/${m.id}/score`, {}, `score-${m.id}`)}>
                {loadingKey === `score-${m.id}` ? 'Verifying…' : 'Run Verify'}
              </button>
              <button className="btn" disabled={loadingKey !== null} onClick={() => run(`/jobs/${id}/milestones/${m.id}/release`, {}, `release-${m.id}`)}>
